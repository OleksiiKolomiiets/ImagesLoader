...
//  Images
//
//  Created by Oleksii  Kolomiiets on 9/13/18.
//  Copyright © 2018 Oleksii  Kolomiets. All rights reserved.
//

import UIKit
// MARK: Took from the https://github.com/maximbilan/UICollectionViewHorizontalPaging
class CenterViewFlowLayout: UICollectionViewFlowLayout {
    ...
    func frameForItemAtIndexPath(_ indexPath: IndexPath) -> CGRect {
        ...
        // Set padding for custom cell
        let pageMarginX = canvasSize.width * ImagesViewControllerSettings.kCellPaddingQuote // 10%
        ...
        // Set width for custom cell
        cellFrame.size.width = canvasSize.width * ImagesViewControllerSettings.kCellWidthQuote // 80%
